...
app.get("/my-user-account", userDetails);
// app.get('/my-user-account', async (req, res) => {
// 	try {
//         // Assuming req.jwt is already populated by some middleware
//         logger.log(`User ${req.jwt.username} is authorized`);
//         logger.log(`User scopes: ${req.jwt.scope}`);

//         const response = {
//             status: "successful",  // Fixed spelling
//             data: "dummy data"
//         };

//         console.log("API call successful");  // Console log for debugging
//         res.status(200).json(response);
//     } catch (error) {
//         console.error("Error handling /my-user-account request:", error);
